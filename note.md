...
[3. Если вам позвонили из Yandex. ](#r)
...
Для macos подойдет Quick Time Player. Сконвертируйте аудио в формат ogg: name_guest.ogg.  Можно онлайн в браузере.
...
## Если вам позвонили из Yandex <a name="r"></a>
